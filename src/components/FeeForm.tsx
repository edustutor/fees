...
export function FeeForm() {
    ...
    return (
        <CardLayout>
            <h2 className="text-3xl font-extrabold text-blue-900 mb-2 text-center">Student Fees</h2>
            <p className="text-center text-gray-500 mb-8 font-medium">Secure Payment Gateway</p>
